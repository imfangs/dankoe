...
await write('docs/.vitepress/sidebar.json',JSON.stringify([{text:'阅读导航',items:[{text:'格得精选',link:'/picks'},{text:'全部文章',link:'/letters/'},{text:'关于本站',link:'/about'}]},...years.map(y=>({text:y+' 年',collapsed:true,items:index.filter(a=>a.date.startsWith(y)).map(a=>({text:a.title,link:a.url}))}))],null,2)+'\n');
await write('docs/index.md',`---\nlayout: doc\nsidebar: false\naside: false\ntitle: 首页\n---\n\n<div class="reading-intro">\n<p class="kicker">DAN KOE · 中文阅读</p>\n<h1>少工作，多赚钱，<br>享受生活。</h1>\n<p class="lead">关于心智、互联网和未来的长文。<br>探索人的潜能，重新设计生活，创造属于自己的事业。</p>\n<div class="intro-links"><a href="/picks">格得精选 · 先读这 10 篇 →</a><a href="/letters/">浏览全部 ${index.length} 篇文章 →</a><a href="/about">了解这个译站</a></div>\n</div>\n\n<div class="section-heading"><h2>从这里开始阅读</h2><a href="/letters/">全部文章 →</a></div>\n\n<ArticleList :limit="8" />\n`);
