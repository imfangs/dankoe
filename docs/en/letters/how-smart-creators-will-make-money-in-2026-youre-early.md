---
title: "How Smart Creators Will Make Money In 2026 (You’re Early)"
search: false
sidebar: false
---

# How Smart Creators Will Make Money In 2026 (You’re Early)

Dan Koe · 2025-05-22 · [原文](https://thedankoe.com/letters/how-smart-creators-will-make-money-in-2026-youre-early/) · [返回中文译文](/letters/how-smart-creators-will-make-money-in-2026-youre-early)

Right now, creators mostly sell digital products and services.
...
My next one is going to be a [30 day challenge to build a personal brand](https://stan.store/thedankoe/p/build-a-profitable-personal-brand-in-30-days).
...
If you want to see this in action, [watch this video I made on the Kortex channel.](https://youtu.be/4E9rO6FDUwo)
...
If you want to make this easier on you, do this in [Kortex](https://kortex.co/) so you can reference that document in an AI chat when we turn this into a prompt. You can copy and paste between something like ChatGPT, but Kortex has ChatGPT models and all other models, so you can pick different ones for different use cases.
...
For creating a YouTube intro, [it could look like this](https://app.kortex.co/public/document/eff80eec-769f-479d-8a00-e1556aac6c6e) (linked in a document because it’s long and detailed).
...
I have a [free AI mini course](https://stan.store/thedankoe/p/mini-course-how-i-systemize-my-life-with-ai) that goes over multiple examples of this.
...
You can either duplicate [the prompt here](https://app.kortex.co/public/document/83651c0d-dfd3-4e6c-9821-c9c41b2a3ddc), or go to **Chat → Create Incredible AI Prompts** inside of Kortex to have this done for you. I like using either Gemini 2.5 Pro or Claude 3.7 Sonnet to do this.

Here is what the prompt looks like to create the prompt.

![](/images/0a89755d05ce1b8510a7.png)

Notice how I provided the instructions in the form of a document and structured it into 2 phases. [Here’s the output of that prompt.](https://app.kortex.co/public/document/d1ac7b33-83f8-4af6-886a-9b9d867d0318)
...
I created a [mega-guide on creating a digital product](https://thedankoe.substack.com/p/mega-guide-how-to-create-your-first) here if you’d like to dive deeper.
...
-   The ‘build a profitable personal brand in 30 days’ challenge goes live on June 16th. It is [discounted for early birds](https://stan.store/thedankoe/p/build-a-profitable-personal-brand-in-30-days).
-   The latest paid posts in Substack are a [mega guide to building a digital product](https://thedankoe.substack.com/p/mega-guide-how-to-create-your-first) and [how to write a sales page](https://thedankoe.substack.com/p/how-to-write-persuasive-landing-pages) for that product. Next will be a launch strategy.
-   Claude 4 just dropped and we will be putting it along with every other AI model [inside Kortex](https://kortex.co/) – a note-taking and AI workflow software.
