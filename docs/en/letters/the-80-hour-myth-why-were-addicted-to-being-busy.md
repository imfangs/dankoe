---
title: "The 80-Hour Myth (Why We’re Addicted To Being Busy)"
search: false
sidebar: false
---
...
Dan Koe · 2025-04-26 · [原文](https://thedankoe.com/letters/the-80-hour-myth-why-were-addicted-to-being-busy/) · [返回中文译文](/letters/the-80-hour-myth-why-were-addicted-to-being-busy)
...
You can speed up busy work with AI [(I actually just created a free mini course on how I use AI since many people asked for it)](https://stan.store/thedankoe/p/mini-course-how-i-systemize-my-life-with-ai).
...
A digital product takes some time (well, not anymore really, because [AI can expedite that process if you have clarity on what you want to build](https://youtu.be/QsyhyMpvPR4)) say, 1-2 hours a day for a month depending on the type of product.

And a landing page takes a few hours to build (again, [you can use AI for this now](https://youtu.be/z9dtU-xUX04)), but once they’re built, you’re literally just focused on generating traffic with content.
...
I find it so powerful that instead of creating multiple newsletters on it, [I put all of my AI use cases into this free mini course](https://stan.store/thedankoe/p/mini-course-how-i-systemize-my-life-with-ai) (the only caveat is that I use my software to teach it).
...
Now, I have a “paradigm shift marketing” strategy for our next big [Kortex](https://kortex.co/) release.
...
Books, videos, courses, and other sources of information are no longer *static.* That information can *do things* for you now. If you fed it my [2 hour writer](https://2hourwriter.com/) course in a smart way, you could have it write posts, threads, and newsletters a lot better than you would be able to on your own.
