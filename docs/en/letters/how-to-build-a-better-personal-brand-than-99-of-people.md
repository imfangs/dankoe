...
Dan Koe · 2025-05-29 · [原文](https://thedankoe.com/letters/how-to-build-a-better-personal-brand-than-99-of-people/) · [返回中文译文](/letters/how-to-build-a-better-personal-brand-than-99-of-people)
...
[Save this prompt to use it after finishing this letter here.](https://app.kortex.co/public/document/9d77482b-0dd9-4dbc-829d-77f2d0364132)

That prompt is a part of the build a profitable personal brand in 30 days challenge that starts June 16th [if you’re interested in more.](https://stan.store/thedankoe/p/build-a-profitable-personal-brand-in-30-days)
...
As an example, John Hu from [Stan](https://join.stan.store/thedankoe) (a creator store that replaces your link in bio and hosts products) found his old resume that got him a Goldman Sachs job and turned that into a template. He made his first few thousand from that alone while talking about career advice. (Oh yeah, for any developers in Toronto out there, we’re hosting a Stan x Kortex hackathon with $15,000 in prizes. The goal is to build a creator tool that allows people to work for themselves. [Apply here if interested](https://hackai.ca/), or send to someone you know!)
...
I’ll leave it there since I’ve already posted a [mega guide to building a digital product.](https://thedankoe.substack.com/p/mega-guide-how-to-create-your-first)

– Dan

When you’re ready, here’s how I can help you:

-   The build a profitable personal brand in 30 days [challenge starts June 16](https://stan.store/thedankoe/p/build-a-profitable-personal-brand-in-30-days). Enroll before then if you want daily tasks that take 30-60 minutes, resulting in the foundations of work you enjoy.
-   [Kortex](https://kortex.co/) is a note-taking and writing app paired with 25+ AI workflows (for content, marketing, and planning). Chat with YT transcripts and PDFs when you sign up.
