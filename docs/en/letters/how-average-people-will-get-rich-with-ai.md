---
title: "How Average People Will Get Rich With AI"
search: false
sidebar: false
---
...
Dan Koe · 2025-05-27 · [原文](https://thedankoe.com/letters/how-average-people-will-get-rich-with-ai/) · [返回中文译文](/letters/how-average-people-will-get-rich-with-ai)
...
1.  **Content** – because this is a media business, and media is how you attract potential customers (no customers, no business).
...
**Note**: The build a profitable personal brand in 30 days challenge starts on June 16. [Join here](https://stan.store/thedankoe/p/build-a-profitable-personal-brand-in-30-days) if you want daily lessons, action steps, and AI prompts that take 30-60 minutes each day. By the end you’ll have a stack of modern high-value skills and the foundations of a profitable brand.
...
I found a few videos that seemed promising. But there’s a [6 hour video from Caleb Ralston](https://youtu.be/Ch4Sl0POBhU) (the guy behind Gary V and Alex Hormozi), so we’re going to use that.
...
I personally did this inside [Kortex](https://kortex.co/) since it can pull from YouTube transcripts, and you can choose between different AI models for different tasks.

I used Gemini 2.5 Pro because it is a reasoning model, and it can handle a lot of context (a 6 hour video is a lot).

The output was an [extremely comprehensive guide](https://app.kortex.co/public/document/41aa3a5d-6e91-4fcf-ac27-388c3fbb95d2) which is exactly what we were looking for.
...
Or, you can [copy the prompt here](https://app.kortex.co/public/document/83651c0d-dfd3-4e6c-9821-c9c41b2a3ddc) and paste it into whatever tool you are using and hit send.
...
The output from that is pretty insane when using a reasoning model like Gemini 2.5 Pro. [Here it is](https://app.kortex.co/public/document/186f6630-7328-4cad-9590-ccfa4b3a76fd). Extremely comprehensive. (I did have to clean it up a bit, make sure you read through the output when you do this.)
...
First, go to the [Write Incredible AI Prompts](https://kortex.co/) workflow, or paste the prompt creator prompt into a new chat.
...
Here’s an example of a [Tweet writing prompt](https://app.kortex.co/public/document/35506957-e550-40f7-9d0f-c9a116561276) I created based on a YouTube video that teaches how to write tweets.
...
Since it takes an entire article to teach this, good content isn’t only about writing social posts. You need to “build a world” of content for people to binge and explore. [I teach that here.](https://thedankoe.substack.com/p/how-to-build-a-world-the-2-hour-content)
...
4.  Break down a PDF like Breakthrough Advertising by Eugene Schwartz into a comprehensive guide to write landing page copywriting. Turn that into a prompt to write your landing page and give it your offer (I also talked about how to do this [in my future of digital products letter last week](/letters/how-smart-creators-will-make-money-in-2026-youre-early)).
...
You have a product that you can start selling ([host it on Stan](https://join.stan.store/thedankoe) if you’re wondering how to accept payment).
...
-   The build a profitable personal brand in 30 days challenge starts on June 16th. If you want 30 days of daily lessons and action steps to reach your first followers and dollars, [join here before enrollment closes.](https://stan.store/thedankoe/p/build-a-profitable-personal-brand-in-30-days)
-   We now have a mega guide to creating a digital product, how to write landing page copy for that product, and how to launch the product [inside the growing premium library.](https://thedankoe.substack.com/)
